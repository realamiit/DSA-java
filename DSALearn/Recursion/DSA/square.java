...
// than after done it call recursive Function 
// return x * power(x * n-1); than close tbe brackat
//  than go to  main and make an object 
// int result = obj.power the power is the name
//  of method (x:2,n:6 ) aur ye dono bracket me both are parameater
//  after understanding this 
//  go for the System.out.println(result) print krwayege 
//  yha ya in this line System ka matlab hai => basickly
//  ye java ki inbuild class hai aur kuch nhi 
