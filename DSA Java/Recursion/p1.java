...
// first we go and cheak and verify the base case if mtlb ydii (n==0)than the operatio will not executed 
...
// again call n = 1 0 nhi hai  n==0 nhit true thqb=n also we get 1 output tha again it compare it with 
...
// again itrate is n=2 than its is also executed bexcause this is also not = to n ==0 than prrint 2
...
// ab fir yhi ktm ho jayega kyuiki hm logone n ki jo calue li tha vo 5 ke equal tha thats why return  and operation is stop as well as;